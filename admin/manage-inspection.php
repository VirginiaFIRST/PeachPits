            ...
            <div class="inspection-map-view">
                ...
                <div class="map-page-team">
                    ...
                    <div id="teaminspection" class="tabcontent">
                        ...
                        <form action="admin/inspection_status?event=<?php echo $currentEvent; ?>&refer=manageinspect&type=changeall" method="post">
			...
			<div class="inspection-list-view">
				<div class="dashboard-content">
					<div class="table-responsive">
						<table class="table table-hover" style="border:1px solid #ddd;">
							<thead>
								...
								<td><b>Robot Weight</b></td>
								<td><b>Red Bumper Weight</b></td>
								<td><b>Blue Bumper Weight</b></td>
								<td><b>Notes</b></td>
							</thead>
							<?php 
                  ...
                  $teamid = $row['teamid'];
									...
									echo "<td id='inspectionstatus'>". $row['inspectionstatus'] ."</td>";
									echo "<td id='robotweight'>". $weights[$teamid]['robotweight'] ."</td>";
									echo "<td id='redbumperweight'>". $weights[$teamid]['redbumperweight'] ."</td>";
									echo "<td id='bluebumperweight'>". $weights[$teamid]['bluebumperweight'] ."</td>";
									echo "<td id='inspectionnotes'>". $row['inspectionnotes'] ."</td>";
								}
							?>
						</table>
...
<div class="modal fade" id="changeInspectionStatus" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="/peachpits/admin/inspection_status?event=<?php echo $currentEvent; ?>&refer=manageinspect&type=changeall" method="post">
        <div class="modal-body">
			    <input type="hidden" name="teamid" id="inspectnumbermodal">
          <h4><b>Inspection Status:</b></h4>
          <select name="inspectionstatus" id="edit-status" class="form-control">
          ...
          <h4><b>Robot Weight:</b></h4>
          <div class="input-group">
            <input type="text" class="form-control" name="robotweight" id="edit-robotweight">
            <div class="input-group-addon">lbs</div>
          </div>
          <h4><b>Red Bumper Weight:</b></h4>
          <div class="input-group">
            <input type="text" class="form-control" name="redbumperweight" id="edit-redbumperweight">
            <div class="input-group-addon">lbs</div>
          </div>
          <h4><b>Blue Bumper Weight:</b></h4>
          <div class="input-group">
            <input type="text" class="form-control" name="bluebumperweight" id="edit-bluebumperweight">
            <div class="input-group-addon">lbs</div>
          </div>
          <h4><b>Inspection Notes:</b></h4>
          <textarea class="form-control map-inspectnotes-modal" id="edit-notes" style="width:100%; height:100px; margin-bottom:5px; resize:none;" name="inspectionnotes"></textarea><br/>
        </div>
        <div class="modal-footer">
